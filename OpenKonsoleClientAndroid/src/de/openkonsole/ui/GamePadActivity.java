...
@EActivity(R.layout.activity_gamepad)
public class GamePadActivity extends Activity implements AnalogStick.Callback {
	
	public static final String INTENT_KEY_HOST_ADDRESS = "host_address";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Ip hostAddress = (Ip) intent.getSerializableExtra(INTENT_KEY_HOST_ADDRESS);
		
		client = new TCPClient(hostAddress);
	...
	@Background
	protected void connectToConsole() {
		try {
			client.connect();
		...
		/* TODO when are these exceptions triggered and how do we handle them?
		 */
	}
