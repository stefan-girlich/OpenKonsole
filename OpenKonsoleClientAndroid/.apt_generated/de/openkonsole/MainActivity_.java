...
import de.openkonsole.R.id;
import de.openkonsole.R.layout;
    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        {
            View view = hasViews.findViewById(id.btn_action_b);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        MainActivity_.this.onButtonBClick();
                    }
        ...
        {
            View view = hasViews.findViewById(id.btn_action_a);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        MainActivity_.this.onButtonAClick();
                    }
